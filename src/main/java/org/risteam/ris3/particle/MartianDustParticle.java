...
package org.risteam.ris3.particle;
...
public class MartianDustParticle extends Ris3ModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public MartianDustParticle(Ris3ModElements instance) {
		super(instance, 55);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("martian_dust"));
	}
