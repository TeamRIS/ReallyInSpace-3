...
public class DustParticle extends Ris3ModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public DustParticle(Ris3ModElements instance) {
		super(instance, 52);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("dust"));
	}
