...
package org.risteam.ris3.world.dimension;

import org.risteam.ris3.procedures.SetupGravityProcedure;
import org.risteam.ris3.procedures.ResetGravityProcedure;
		...
		if (event.getFrom() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("ris3:mars"))) {
			{
				...
				ResetGravityProcedure.executeProcedure($_dependencies);
			}
		}
