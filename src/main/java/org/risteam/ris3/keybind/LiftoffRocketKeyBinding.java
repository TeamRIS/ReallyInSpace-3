...
package org.risteam.ris3.keybind;
...
public class LiftoffRocketKeyBinding extends Ris3ModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public LiftoffRocketKeyBinding(Ris3ModElements instance) {
		super(instance, 58);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.liftoff_rocket", GLFW.GLFW_KEY_SPACE, "key.categories.gameplay");
