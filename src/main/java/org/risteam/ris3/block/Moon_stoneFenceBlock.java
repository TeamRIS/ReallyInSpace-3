...
public class Moon_stoneFenceBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:moon_stone_fence")
	public static final Block block = null;
	public Moon_stoneFenceBlock(Ris3ModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_stone_fence");
		}
