...
public class MercuryStoneStairsBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_stairs")
	public static final Block block = null;
	public MercuryStoneStairsBlock(Ris3ModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_stairs");
		}
