...
public class MercuryStoneStoneButtonBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_stone_button")
	public static final Block block = null;
	public MercuryStoneStoneButtonBlock(Ris3ModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_stone_button");
		}
