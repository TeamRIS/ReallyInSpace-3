...
public class MercuryStoneTrapDoorBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_trap_door")
	public static final Block block = null;
	public MercuryStoneTrapDoorBlock(Ris3ModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_trap_door");
		}
