...
public class Moon_stoneStoneButtonBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:moon_stone_stone_button")
	public static final Block block = null;
	public Moon_stoneStoneButtonBlock(Ris3ModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_stone_stone_button");
		}
