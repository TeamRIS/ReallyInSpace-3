...
public class MartianStoneWallBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_wall")
	public static final Block block = null;
	public MartianStoneWallBlock(Ris3ModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_wall");
		}
