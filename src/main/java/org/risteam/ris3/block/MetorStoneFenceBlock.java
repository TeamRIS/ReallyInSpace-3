...
public class MetorStoneFenceBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_fence")
	public static final Block block = null;
	public MetorStoneFenceBlock(Ris3ModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_fence");
		}
