...
public class MetorStoneStoneButtonBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_stone_button")
	public static final Block block = null;
	public MetorStoneStoneButtonBlock(Ris3ModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_stone_button");
		}
