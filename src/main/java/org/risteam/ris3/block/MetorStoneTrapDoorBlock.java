...
public class MetorStoneTrapDoorBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_trap_door")
	public static final Block block = null;
	public MetorStoneTrapDoorBlock(Ris3ModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_trap_door");
		}
