...
public class MartianStoneStairsBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_stairs")
	public static final Block block = null;
	public MartianStoneStairsBlock(Ris3ModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_stairs");
		}
