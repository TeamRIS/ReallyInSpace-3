...
public class MercuryStoneDoorBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_door")
	public static final Block block = null;
	public MercuryStoneDoorBlock(Ris3ModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_door");
		}
