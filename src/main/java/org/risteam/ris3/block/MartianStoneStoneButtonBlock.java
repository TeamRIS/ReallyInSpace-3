...
public class MartianStoneStoneButtonBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_stone_button")
	public static final Block block = null;
	public MartianStoneStoneButtonBlock(Ris3ModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_stone_button");
		}
