...
public class MercuryStoneWallBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_wall")
	public static final Block block = null;
	public MercuryStoneWallBlock(Ris3ModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_wall");
		}
