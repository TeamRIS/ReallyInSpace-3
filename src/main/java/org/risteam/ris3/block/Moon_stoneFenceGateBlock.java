...
public class Moon_stoneFenceGateBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:moon_stone_fence_gate")
	public static final Block block = null;
	public Moon_stoneFenceGateBlock(Ris3ModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_stone_fence_gate");
		}
