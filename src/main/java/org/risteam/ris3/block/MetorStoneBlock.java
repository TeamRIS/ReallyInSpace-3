...
public class MetorStoneBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone")
	public static final Block block = null;
	public MetorStoneBlock(Ris3ModElements instance) {
		super(instance, 82);
	}
