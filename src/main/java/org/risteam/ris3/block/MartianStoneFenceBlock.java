...
public class MartianStoneFenceBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_fence")
	public static final Block block = null;
	public MartianStoneFenceBlock(Ris3ModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_fence");
		}
