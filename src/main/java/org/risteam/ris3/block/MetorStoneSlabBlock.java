...
public class MetorStoneSlabBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_slab")
	public static final Block block = null;
	public MetorStoneSlabBlock(Ris3ModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_slab");
		}
