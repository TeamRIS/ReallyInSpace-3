...
public class MartianStoneSlabBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_slab")
	public static final Block block = null;
	public MartianStoneSlabBlock(Ris3ModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_slab");
		}
