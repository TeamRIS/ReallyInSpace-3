...
public class MercuryStoneFenceGateBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_fence_gate")
	public static final Block block = null;
	public MercuryStoneFenceGateBlock(Ris3ModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_fence_gate");
		}
