...
public class MetorStoneFenceGateBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_fence_gate")
	public static final Block block = null;
	public MetorStoneFenceGateBlock(Ris3ModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_fence_gate");
		}
