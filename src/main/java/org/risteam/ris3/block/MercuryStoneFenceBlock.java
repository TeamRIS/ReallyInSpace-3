...
public class MercuryStoneFenceBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:mercury_stone_fence")
	public static final Block block = null;
	public MercuryStoneFenceBlock(Ris3ModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("mercury_stone_fence");
		}
