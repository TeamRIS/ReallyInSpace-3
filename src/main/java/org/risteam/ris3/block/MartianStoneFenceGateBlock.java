...
public class MartianStoneFenceGateBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:martian_stone_fence_gate")
	public static final Block block = null;
	public MartianStoneFenceGateBlock(Ris3ModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("martian_stone_fence_gate");
		}
