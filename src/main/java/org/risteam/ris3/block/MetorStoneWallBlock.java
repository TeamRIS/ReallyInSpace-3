...
public class MetorStoneWallBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_wall")
	public static final Block block = null;
	public MetorStoneWallBlock(Ris3ModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_wall");
		}
