...
public class MetorStoneStairsBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metor_stone_stairs")
	public static final Block block = null;
	public MetorStoneStairsBlock(Ris3ModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("metor_stone_stairs");
		}
